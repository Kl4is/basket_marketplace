import productIconShort from '../img/item-01.jpg'
import productIconCase from '../img/item-02.jpg'
import productIconPencils from '../img/item-03.jpg'
import cardIconMir from '../img/icons/icon-card-mir.svg'
import cardIconVisa from '../img/icons/icon-card-visa.svg'
import cardIconMasterCard from '../img/icons/icon-card-mastercard.svg'
import cardIconMaetro from '../img/icons/icon-card-maetro.svg'
